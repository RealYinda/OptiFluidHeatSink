...
private:
  ...
  /// 训练中使用的文件名
  string d_simulation_data_name;
  std::string g_sim_id = "0000";                 // 存储 0000 到 2999 的编号
  std::map<int, double> g_boundary_to_flux;      // Map字典: 面编号 -> 热通量 q
  double g_inlet_velocity = 0.0;                 // 从文件读出的流速
